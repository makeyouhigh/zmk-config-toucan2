...
try {
    ...
    if ($status -notmatch '^STATUS,(v11|v12|v13|v14|v15|v16|v17|v18|v19),(1|2),') {
        throw "Unexpected firmware: $status"
    }
    $version = $Matches[1]
    $protocol = $Matches[2]
    if (($version -in @('v14','v15','v16','v17','v18','v19')) -ne ($protocol -eq '2')) { throw "Unexpected protocol: $status" }
