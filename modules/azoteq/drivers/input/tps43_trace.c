...
static void trace_thread(void *a, void *b, void *c) {
    ...
    for (;;) {
        ...
        if (command == 'G') {
            ...
            snprintk(line, sizeof(line), "LEVELS,v18,2,%u,%u,%u,%u,%u\n",
        ...
        if (command == 'A') {
            if (capturing || touching) {
                ...
                started_ms = now;
                capturing = true;
                snprintk(line, sizeof(line), "ARM,v18,2,%u,%u\n", started_ms, TRACE_MS);
            }
        } else if (command == 'S') {
            snprintk(line, sizeof(line), "STATUS,v18,2,%u,%u,%u,%u,%u,%u,%u\n",
            ...
            if (capturing || touching) {
                ...
                cursor = 0;
                snprintk(line, sizeof(line), "DATA,v18,2,%u,%u,%u,%u\n",
